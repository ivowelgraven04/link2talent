...
import { ArrowRight, UserCircle, Handshake, EnvelopeSimple } from "@phosphor-icons/react/dist/ssr";
        ...
        <div className="grid md:grid-cols-3 gap-4">
          {services.map((s, i) => (
            <ScrollReveal key={s.title} delay={i * 0.1}>
              <div className="relative flex flex-col gap-6 rounded-2xl p-8 border h-full bg-white/[0.03] border-white/[0.08] hover:border-white/[0.15] transition-all duration-200">
                <div>
